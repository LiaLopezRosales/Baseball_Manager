...
\begin{document}
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|}
        ...
        \hline
        founded\_year & PositiveSmallIntegerField & Año de fundación de la franquicia. & Nulo permitido. \\
        \hline
        stadium & CharField & Nombre del estadio. & Puede estar vacío. \\
        \hline
        capacity & PositiveIntegerField & Capacidad del estadio. & Nulo permitido. \\
        \hline
        division & CharField & División de la liga a la que pertenece. & Puede estar vacío. \\
        \hline
        slogan & TextField & Eslogan de la franquicia. & Puede estar vacío. \\
        \hline
    \end{tabular}
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|}
        ...
        \hline
        bio & TextField & Breve biografía del jugador. & Puede estar vacío. \\
        \hline
        photo & ImageField & Fotografía del jugador. & Nulo permitido. \\
        \hline
        birth\_date & DateField & Fecha de nacimiento. & Nulo permitido. \\
        \hline
        height\_cm & PositiveSmallIntegerField & Altura en centímetros. & Nulo permitido. \\
        \hline
        weight\_kg & PositiveSmallIntegerField & Peso en kilogramos. & Nulo permitido. \\
        \hline
        nationality & CharField & Nacionalidad. & Puede estar vacío. \\
        \hline
    \end{tabular}
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|}
        ...
        \hline
        home\_runs & PositiveIntegerField & Jonrones acumulados. & Valor por defecto 0. \\
        \hline
        rbi & PositiveIntegerField & Carreras impulsadas. & Valor por defecto 0. \\
        \hline
        obp & FloatField & Porcentaje de embasado (on-base percentage). & Valor por defecto 0. \\
        \hline
        slg & FloatField & Slugging (porcentaje de slugging). & Valor por defecto 0. \\
        \hline
        war & FloatField & Wins Above Replacement (valor sobre el reemplazo). & Valor por defecto 0. \\
        \hline
        bats & CharField & Mano de bateo. & Opciones: 'R' (Diestro), 'L' (Zurdo). \\
        \hline
        throws & CharField & Mano de lanzamiento. & Opciones: 'R' (Diestro), 'L' (Zurdo). \\
        \hline
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|}
        ...
        \hline
        strikeouts & PositiveIntegerField & Ponches acumulados. & Valor por defecto 0. \\
        \hline
        innings\_pitched & FloatField & Entradas lanzadas. & Valor por defecto 0. \\
        \hline
        saves & PositiveIntegerField & Salvamentos acumulados. & Valor por defecto 0. \\
        \hline
        whip & FloatField & Walks + hits sobre entradas lanzadas. & Valor por defecto 0. \\
        \hline
    \end{tabular}
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|}
        ...
        \hline
        fielding\_pct & FloatField & Porcentaje de fildeo. & Valor por defecto 0. \\
        \hline
        double\_plays & PositiveIntegerField & Dobles jugadas. & Valor por defecto 0. \\
        \hline
        bases\_stolen & PositiveIntegerField & Bases robadas. & Valor por defecto 0. \\
        \hline
        assists\_of & PositiveIntegerField & Asistencias del jugador de los jardines. & Valor por defecto 0. \\
        \hline
    \end{tabular}
    ...
    \subsection*{Tabla: FavoriteTeam}
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|}
        \hline
        \textbf{Campo} & \textbf{Tipo de Dato} & \textbf{Descripción} & \textbf{Restricciones} \\
        \hline
        id & AutoField (PK) & Identificador único del favorito de equipo. & Primary Key \\
        \hline
        user & ForeignKey (User) & Usuario al que pertenece el favorito. & No nulo, relación con \texttt{User}. \\
        \hline
        team & ForeignKey (Team) & Equipo marcado como favorito. & No nulo, relación con \texttt{Team}. \\
        \hline
    \end{tabular}

    \textbf{Restricciones adicionales:}
    \begin{itemize}
        \item Un usuario no puede marcar dos veces el mismo equipo (\texttt{UniqueConstraint} sobre \texttt{user} y \texttt{team}).
    \end{itemize}

    ---

    \subsection*{Tabla: FavoritePlayer}
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|}
        \hline
        \textbf{Campo} & \textbf{Tipo de Dato} & \textbf{Descripción} & \textbf{Restricciones} \\
        \hline
        id & AutoField (PK) & Identificador único del favorito de jugador. & Primary Key \\
        \hline
        user & ForeignKey (User) & Usuario al que pertenece el favorito. & No nulo, relación con \texttt{User}. \\
        \hline
        player & ForeignKey (BaseballPlayer) & Pelotero marcado como favorito. & No nulo, relación con \texttt{BaseballPlayer}. \\
        \hline
    \end{tabular}

    \textbf{Restricciones adicionales:}
    \begin{itemize}
        \item Un usuario no puede marcar dos veces el mismo jugador (\texttt{UniqueConstraint} sobre \texttt{user} y \texttt{player}).
    \end{itemize}

    ---

    \subsection*{Tabla: Notification}
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{6cm}|>{\raggedright\arraybackslash}p{4cm}|}
        \hline
        \textbf{Campo} & \textbf{Tipo de Dato} & \textbf{Descripción} & \textbf{Restricciones} \\
        \hline
        id & AutoField (PK) & Identificador único de la notificación. & Primary Key \\
        \hline
        user & ForeignKey (User) & Usuario destinatario. & No nulo, relación con \texttt{User}. \\
        \hline
        message & TextField & Texto de la notificación. &  \\
        \hline
        link & CharField & Ruta a la que enlaza la notificación. & Puede estar vacío. \\
        \hline
        is\_read & BooleanField & Indica si la notificación fue leída. & Valor por defecto \texttt{False}. \\
        \hline
        created\_at & DateTimeField & Fecha de creación. & Se asigna automáticamente. \\
        \hline
    \end{tabular}
    
    \textbf{Restricciones adicionales:}
    \begin{itemize}
        \item Las notificaciones se ordenan de forma descendente por \texttt{created\_at}.
        \item Se generan automáticamente mediante el signal \texttt{post\_save} del modelo \texttt{Score}
        cuando se registra un resultado: se crea una notificación para cada seguidor de los equipos
        ganador y perdedor.
    \end{itemize}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{tablas.png}
    ...
    \begin{itemize}
        \item React utiliza un sistema de estado (por ejemplo, con \texttt{useState}, \texttt{useEffect} o bibliotecas como Redux) para manejar los datos que se muestran en la interfaz.
    ...
    \subsubsection*{Renderizado Dinámico}
    \begin{itemize}
    ...
    \subsubsection*{Enrutamiento (URLs)}
    \begin{itemize}
    ...
    \subsubsection*{Modelos y Base de Datos}
    \begin{itemize}
    ...
    \subsection*{Flujo Completo de una Solicitud}
    ...
    \section*{API REST pública}
    El backend expone una API REST construida con Django REST Framework. Los endpoints de consultas
    dinámicas y reportes son de acceso público; las operaciones de usuario (favoritos, notificaciones,
    panel) requieren autenticación por token (\texttt{Authorization: Token <token>}). Entre los endpoints
    principales se encuentran:

    \begin{itemize}
        \item \texttt{GET /teams/}, \texttt{/persons/}, \texttt{/baseball-players/},
        \texttt{/players-in-position/}, \texttt{/positions/}, \texttt{/series/}, \texttt{/games/},
        \texttt{/scores/}: CRUD público y consultas de las entidades.
        \item \texttt{POST /api/login/}: autenticación (devuelve token, rol y permisos del usuario).
        \item \texttt{POST /api/register/}: registro público de un Usuario General.
        \item \texttt{GET /api/user/dashboard/}: panel personal del usuario (equipo favorito, últimos
        juegos, estrella del equipo).
        \item \texttt{POST /api/user/favorites/team/} y \texttt{/player/}: alternar favoritos.
        \item \texttt{GET /api/notifications/}, \texttt{POST /api/notifications/read/} y \texttt{read-all/}:
        notificaciones del usuario.
        \item \texttt{GET /api/queries/reports/?report\_id=N}: los 9 reportes oficiales.
        \item \texttt{POST /api/queries/dinamic-filter/}: filtro dinámico sobre cualquier entidad
        (excepto \texttt{User} y \texttt{Rol}).
        \item \texttt{POST /api/queries/export/}: exportación de reportes a PDF o CSV (restringida a
        usuarios autenticados).
        \item \texttt{GET /api/team-profile/<id>/} y \texttt{/pdf/}: perfil de franquicia y ficha PDF.
        \item \texttt{GET /api/player-swap/<team>/}, \texttt{POST /api/player-swap/},
        \texttt{GET /api/player-swap/available/...} y \texttt{/api/player-swaps/team/<team>/}: gestión de
        cambios de alineación del Director Técnico.
    \end{itemize}

    La autenticación usa una clase \texttt{FlexibleTokenAuthentication} que omite el chequeo de
    \texttt{is\_active} del modelo de usuario; los permisos por vista se aplican mediante clases de
    permisos personalizadas (Admin, Director Técnico o lectura pública).

    \section*{Despliegue en producción (Render + Neon)}
    La aplicación se despliega en \textbf{Render} con base de datos \textbf{Neon serverless}
    (PostgreSQL), ambos en sus planes gratuitos:

    \begin{itemize}
        \item \textbf{Frontend} (\texttt{baseball-manager-frontend}): \textbf{Static Site} con el build de
        React (\texttt{CI=false npm run build}). El \texttt{REACT\_APP\_API\_URL} se inyecta en el build.
        El \textit{fallback} de rutas de React Router se configura con una regla de \textbf{Rewrite} en el
        Dashboard de Render (origen \texttt{/*} to \texttt{/index.html}); sin ella, las rutas internas
        devuelven 404 al recargar. El archivo \texttt{public/\_redirects} queda solo como compatibilidad
        Netlify.
        \item \textbf{Backend} (\texttt{baseball-manager-api}): \textbf{Web Service} construido con
        \texttt{Dockerfile.backend} (imagen oficial de Python). Las migraciones están gitignoreadas, por lo
        que el entrypoint de producción ejecuta \texttt{makemigrations --noinput} y \texttt{migrate} antes
        de arrancar. Usa \texttt{gunicorn} con \texttt{--workers 1} (instancia free de 512~MB), CORS
        configurado al origen real del frontend y \texttt{DEBUG=false}.
        \item \textbf{Seed de datos}: se ejecuta el comando \texttt{seed\_demo} (idempotente y
        auto-reparable): si la base está vacía siembra todo el campeonato; si los equipos no tienen
        resultados, limpia y resiembra; si está completa, se omite.
        \item \textbf{Salud y disponibilidad}: el Web Service se duerme a los 15 minutos de inactividad en
        el plan free; un monitor externo (p.~ej. UptimeRobot) ejecuta una petición cada 5 minutos contra
        \texttt{/teams/} para mantenerlo despierto.
        \item \textbf{Base de datos}: Neon serverless free (sin caducidad, a diferencia del Postgres
        integrado de Render que expira a los 90 días). Las credenciales se inyectan por las variables de
        entorno \texttt{DB\_*} y \texttt{DB\_SSLMODE}.
    \end{itemize}
