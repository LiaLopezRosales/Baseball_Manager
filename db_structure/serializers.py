...
class SeriesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Series
        fields = ['id', 'season', 'season_id', 'name', 'type', 'init_date', 'end_date']
...
class StarPlayerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StarPlayer
        fields = [
            'series', 'season', 'position', 'BP_id', 
            'series_id', 'season_id', 'position_id', 'BP_id'
        ]
...
class PlayerInPositionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['BP_id', 'position', 'effectiveness', 'BP_id_id', 'position_id']
...
class PlayerSwapSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PlayerSwap
        fields = [
            'old_player', 'new_player', 'position', 'game_team',
            'old_player_id', 'new_player_id', 'position_id', 'game_team_id',
            'date'
        ]
