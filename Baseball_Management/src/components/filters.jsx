...
const Filters = ({ table, fields, values = {}, setFilters }) => {
    ...
    const handleFilterChange = (field, value, filterType) => {
        // Solo parsea el valor si el filtro es para números
        const parsedValue = (filterType === 'gte' || filterType === 'lte' || filterType === 'month' || filterType === 'year')
            ? parseInt(value, 10)
            : value;
        ...
        setFilters(prevFilters => {
            ...
            // Si el valor está vacío o no es válido, elimina el filtro
