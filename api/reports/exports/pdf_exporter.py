...
class PDFExporter(BaseExporter):
    ...
    # def export(self, data):
    #     buffer = BytesIO()
    #     # Configuramos la página en orientación horizontal
    #     doc = SimpleDocTemplate(buffer, pagesize=landscape(letter))
    #     styles = getSampleStyleSheet()
    #     elements = []

    #     # Iterar sobre cada sección y agregar sus elementos
    #     for title, rows in data.items():
    ...
    #             # Crear la tabla con encabezados repetidos
    #             table = Table(table_data, repeatRows=1)
    #             table.setStyle(TableStyle([
    #                 ("BACKGROUND", (0, 0), (-1, 0), colors.grey),
    #                 ("TEXTCOLOR", (0, 0), (-1, 0), colors.whitesmoke),
    ...
    #     # Función para dibujar el encabezado y el logo en cada página
    #     def header(canvas, doc):
    #         canvas.saveState()
    #         width, height = doc.pagesize
    #         # Dibujar el logo 
    ...
    #         # Dibujar el texto del encabezado con una frase profesional
    #         canvas.setFont("Helvetica-Bold", 16)
    #         canvas.drawCentredString(width / 2.0, height - 45, "Reporte de Estadísticas")
    ...
    #     # Construir el documento, aplicando el encabezado en la primera y en las siguientes páginas
    #     doc.build(elements, onFirstPage=header, onLaterPages=header)
